...
- **ยังไม่มี:** สมุดซื้อจากใบเสร็จทุกใบอัตโนมัติ · e-Tax ส่งจริง · ภ.พ.30 ทางการ (มีแค่กระดาษทำงานช่อง 1–12) · GL/journal
...
ยังไม่มีทั้งระบบ: ลิ้นชักเงินสด · ตัดสต๊อกอัตโนมัติตอนรับงาน · ใบลดหนี้ที่กลับรายการ `sc_sales` หรือคืนสต๊อก · VAT effective date · GL/journal · e-Tax ส่งจริง · ภ.พ.30 ทางการ (มีกระดาษทำงานช่อง 1–12 แล้วยังไม่ใช่แบบยื่น) · สมุดภาษีซื้ออัตโนมัติจากทุกใบเสร็จซื้อ
