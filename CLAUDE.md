...
### บันทึกย้อนหลัง: เงินเดือนไมโล มิ.ย./ก.ค. 69 (2026-09-08)
Excel ของเจ้าของมีแถว "ไมโล 10,000" ในค่าแรงพนักงานทุกเดือน แต่ `sc_opex` **ไม่เคยมีแถวนี้ใน
06/2026 และ 07/2026 เลย** (ส.ค. มีในชื่อ `เงินเดือนหุ้นส่วนผู้จัดการ (ไม่หัก ปกส.)` ฿20,000)
⇒ กำไรสองเดือนนั้นสูงเกินจริงเดือนละ ฿10,000 · บันทึกย้อนหลังแล้วตามคำสั่งเจ้าของ
(id 2108, 2109 · category `ค่าแรง & เงินเดือน` · มี `sc_audit_logs` กำกับพร้อมเหตุผล)
...
- **🟡 `ค่าที่ปรึกษา` ฿10,000/เดือน มีในระบบแต่ไม่มีใน Excel** (มิ.ย. + ก.ค. · ม.ค./ก.พ. เคยเป็น
  ฿12,000 · พ.ค. และ ส.ค. ไม่มีเลย) — **ยังไม่แตะ รอเจ้าของยืนยันว่าจ่ายจริงหรือลงผิด**
  ตอนนี้จึงเป็นความต่างที่เหลืออยู่เพียงอย่างเดียว: ทั้งสองเดือนต่างจาก Excel **฿10,000.00 พอดี**

หลังบันทึกครบ: มิ.ย. ค่าใช้จ่าย ฿86,108.34 กำไรหลังแบ่ง ฿4,351.66 · ก.ค. ค่าใช้จ่าย ฿78,992.06
กำไรหลังแบ่ง ฿10,879.52 (เงินเข้าจริง) / ฿11,079.52 (ตามบิล) · **ส.ค. ไม่ขยับ ฿24,524.79**
