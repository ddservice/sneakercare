...
- **รายได้ค่าเช่าห้อง** กรอกที่ `/expenses` การ์ดเขียว “รายได้อื่น — ค่าเช่าห้องจากพนักงาน” เลือกชื่อพนักงานผู้จ่ายหรือกรอกเอง · ลงบัญชียังยอดเต็ม · ถ้าผู้เช่าหักภาษีร้านไว้ กรอกอัตราได้
- **`/tax-filing`** ใช้แถว `sc_wht_certificates` จริง (payable เท่านั้นสำหรับไฟล์ ภ.ง.ด.3/53 + พิมพ์ 50 ทวิ) เลิกเดา 3% จากรายจ่าย ≥ ฿1,000
- **แบบ 50 ทวิ:** เทมเพลต `components/tawi50-certificate.tsx` — จำนวนเงินเป็นตัวเลขหน่วยบาท (ไม่ใช้ $) · มีตัวอักษรกำกับภาษีนำส่งจาก `thaiBahtText` · checkbox เงื่อนไขหักภาษีค่าเริ่มต้น (1) หัก ณ ที่จ่าย · ประเภทเงินได้มีมาตรา เช่น ค่าเช่าอาคาร/อสังหาริมทรัพย์ (มาตรา 40(5)) · ลายเซ็น/ตราประทับดึงจาก `/settings` (`signatory_name` / `signature_url` / `stamp_url`) ประทับอัตโนมัติตอนพิมพ์
