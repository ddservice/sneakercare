...
อยู่ที่ `supabase/migrations/` เรียงลำดับ 0001-0007+ — **ห้ามแก้ไฟล์ migration เก่าที่ apply ไปแล้ว** สร้าง
...
- **2026-07-12**: เพิ่มความสามารถให้กรอกราคาตอน "เพิ่มสินค้าใหม่" (ไม่ใช่แค่ตอนรับของเข้าคลังแบบเดิม) —
  ...
  **ถือเป็นช่องโหว่ RLS ที่มีอยู่เดิมและยังไม่ได้แก้** — ถ้ามีเวลาควรเพิ่ม role check ใน
  `inv_p_stock_txn_select` ให้ตรงกับกฎ "Staff ต้องไม่เห็นข้อมูลต้นทุน" ไม่ใช่พึ่งแค่การซ่อน UI/query ผ่าน
  audit log เป็นทางเลี่ยงเหมือนตอนนี้
