...
ไม่มี: ลิ้นชักเงินสด · checkout อะตอมมิกขาย+สต๊อก+รับชำระ · กันสต๊อกติดลบแบบปฏิเสธที่ DB (ตอนนี้ `greatest(0, …)` ปัดเหลือ 0) · ใบลดหนี้/เพิ่มหนี้ · VOID ที่เก็บเลข · เลขเอกสารตอน issue แยกจาก draft · VAT effective date · snapshot ผู้ขายบนเอกสาร · GL/journal/ปิดงวด · e-Tax ส่งจริง · ภ.พ.30 ทางการ · idempotency key ของการขาย · รายงานที่เรียกว่างบโดยไม่กระทบยอด
