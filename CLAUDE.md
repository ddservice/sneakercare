...
- โลโก้ร้านค้า (`biz_logo_url`) ที่ฝากไว้กับเว็บฝากรูปฟรีบางเจ้า (เช่น pic.in.th) อาจโหลดไม่ขึ้นเพราะ hotlink
  protection แม้ URL จะถูกต้อง — เพิ่ม error message ที่ชัดเจนไว้แล้วเวลาโหลดไม่สำเร็จ แต่ไม่ใช่บั๊กของเว็บนี้
  แนะนำผู้ใช้เปลี่ยนไปใช้เว็บฝากรูปที่อนุญาต hotlinking แทนถ้าเจอปัญหานี้อีก
