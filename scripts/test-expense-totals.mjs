...
const catCases = [
  ...
  ["ค่าเช่าอาคาร/สถานที่", "", "building_rent", "shortLabel ตรงเป๊ะ (ค่าเช่าอาคาร)"],
  ["building_rent", "", "building_rent", "ส่งเป็น key มาอยู่แล้ว"],
  ["ค่าดำเนินการ", "ค่าเช่าตึกประจำเดือน", "building_rent", "ชื่อรายการค่าเช่าตึก → หมวดใหม่ ไม่ปนสาธารณูปโภค"],
