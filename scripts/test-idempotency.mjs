...
check(isIdempotentReplay({ code: "23505", message: 'duplicate key value violates unique constraint "sc_sales_tenant_order_uidx"' }), "ชน unique ใบรับงานนับเป็น replay", "ไม่จับ tenant_order_uidx");
